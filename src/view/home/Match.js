...
const data = [
  {
    matchLink1: "./img/gt.svg.png",
    matchLink2: "./img/dc.png",
    date: "17/5/2024",
    time: "14:00:00",
    matchtype: "CSA T20 Challenge",
  },
  {
    matchLink1: "./img/rr.png",
    matchLink2: "./img/srh.png",
    date: "17/5/2024",
    time: "14:00:00",
    matchtype: "Indian Premier League",
  },
  {
    matchLink1: "./img/gt.svg.png",
    matchLink2: "./img/MI.png",
    date: "17/5/2024",
    time: "16:00:00",
    matchtype: "CSA T20 Challenge",
  },
  {
    matchLink1: "./img/rcb.png",
    matchLink2: "./img/punjab.png",
    date: "18/5/2024",
    time: "14:00:00",
    matchtype: "Indian Premier League",
  },
  ...
  {
    matchLink1: "./img/kkr.png",
    matchLink2: "./img/lsg.png",
    date: "19/5/2024",
    time: "14:00:00",
    matchtype: "Indian Premier League",
  },
      ...
      {data.map((item, index) => (
        <Box key={index}>
          ...
          <Team>
            <TeamDetail>
              <Team1>
                <img src={item.matchLink1} alt="team"></img>
              </Team1>
              <Verses>
                <img src="./img/vs.png" alt="verses"></img>
              </Verses>
              <Team2>
                <img src={item.matchLink2} alt="team"></img>
              </Team2>
            </TeamDetail>
          </Team>
          <DateTime>
...
const Box = styled.div`
  ...
  background-image: radial-gradient(rgb(26, 106, 104), rgba(0, 31, 100, 0.75)),
    url("./img/2488394_336467-PAXADE-566.jpg");
